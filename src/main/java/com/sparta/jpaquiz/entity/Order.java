...
public class Order {
    ...
    /**
     * TODO (written) 2(Entity 생성자 기본값 설정): @PrePersist를 사용해 createdAt, status 필드에 기본값을 설정합니다.
     * <hr/>
    ...
    /**
     * TODO 5: (written) Entity 가 Dto 에 의존하는 '의존성 역전 원칙 위반'을 수정
     * <hr>
     ...
     *
     * @param orderNumber {@link OrderDto} 주문 생성 요청 객체 입니다.
